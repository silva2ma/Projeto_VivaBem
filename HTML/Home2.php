...
if ($tela == "sucesso") {
    $valor = $_GET["valor"];
    $comando = "SELECT id FROM doavalor";
    $resulta1 = mysqli_query($con, $comando);
    if ($resulta1) {
        $ids = [];
        while ($row = mysqli_fetch_array($resulta1)) {
            $ids[] = $row['id']; // Adiciona cada ID ao array
        }

        $idfinal = end($ids);

        $comando2 = "UPDATE doavalor SET valor='" . $valor . ",00' WHERE id='" . $idfinal . "'";
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-center flex-grow-1 pe-2">
                ...
                <li class="nav-item">
                  <a class="nav-link mx-lg-2" href="#noticia">Notícias</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    ...
                    <img src="https://vivabem.serv00.net/projeto/site/img_users/<?php  $img= $_SESSION['img'];echo $img;?>" style="width: 65px; height: 65px; position:absolute; top:20px ; right: 80px; border-radius: 100%;  object-fit: cover; border: 2px solid #722277;"  class="user-pic"  onclick="toggleMenu()"></a>
                   
                   </li>
               
                        <div class="sub-menu-wrap" id="subMenu" style="border-radius:19%; position: absolute; left:70%;">
          <div class="sub-menu">
            <div class="user-info">
              <img style="height: 80px; width: 90px; border: 2px ; border-radius: 50%; object-fit: cover; "
              src="https://vivabem.serv00.net/projeto/site/img_users/<?php  $img= $_SESSION['img'];echo $img;?>" alt="">
            ...
            <a href= "https://vivabem.serv00.net/HTML/suporte.php" class="sub-menu-link">
...
<script>
    function confirmLogout(event) {
        ...
        Swal.fire({
            ...
            background: '#ae61b3', // Fundo do alert
...
<body>
      ...
      <div class="container mt-5">
        ...
        <div class="text-center mb-xl-7 mb-5" data-cue="fadeIn">
            <small class="text-uppercase ls-md" style="color: #ae61b3;">NOTÍCIAS SOBRE A POPULAÇÃO IDOSA</small>
        ...
        <form action="processar-pergunta.php" method="POST">
            <div class="form-row">
                <div>
                    ...
                    <input type="text"  name="nome" id="sendername" required>
                </div>
                <div>
                    <label for="sobrenome">Sobrenome:</label>
                    <input type="text"  name="sobrenome" id="to" required>
                </div>
            </div>
    
            <label for="email">E-mail:</label>
            <input type="email" id="subject" name="email" placeholder="exemplo@.com" required>
    
            <label for="telefone">Telefone:</label>
            <input type="tel" maxlength="15" onkeyup="handlePhone(event)"  placeholder="Telefone">
           <label for="pergunta">Mensagem:</label>
              <textarea id="pergunta" name="pergunta" rows="5" required></textarea>
      ...
      <div class="col-md-7">
        ...
        <div class="thumbnail">
          <a href="/w3images/lights.jpg"></a>
            <img src="../IMAGENS/IMG_5808.jpg" alt="Lights" style="border-radius: 50%; width: 150px; height: 150px; width: 85px;
