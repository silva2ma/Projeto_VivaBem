...
$stmt = $con->prepare("INSERT INTO inscricao(nome, sobrenome, email, datanasc, projeto, idade, telefone) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("sssssss", $nomex, $sobrenome, $email, $datax, $projeto, $idade, $telefone);
