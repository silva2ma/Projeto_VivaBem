...
if (isset($_SESSION["usuario"])) {
    ...
    $rede= "Rede de Assistência Comunitária"; // Valor dos encontros a ser atualizado
    ...
    mysqli_stmt_bind_param($stmt, "ss", $rede, $loginx); // Atualiza fav_app com encontros onde login é igual ao usuário
