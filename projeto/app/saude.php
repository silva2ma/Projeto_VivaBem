...
if (isset($_SESSION["usuario"])) {
    ...
    $saude= "Saúde em Foco"; // Valor dos encontros a ser atualizado
    ...
    mysqli_stmt_bind_param($stmt, "ss", $saude, $loginx); // Atualiza fav_app com encontros onde login é igual ao usuário
